...
public class TACompat_Tinkers {
	...
	public static void preinitMetalsAndMaterials() {
		...
		TinkerRegistry.integrate(cerulean, TABlocks.MOLTENCERULEAN, "Cerulean").toolforge().preInit();
		...
		TinkerRegistry.integrate(moonstone, TABlocks.MOLTENMOONSTONE, "Moonstone").toolforge().preInit();
