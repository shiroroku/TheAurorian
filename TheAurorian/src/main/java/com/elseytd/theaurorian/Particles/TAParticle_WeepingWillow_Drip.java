...
public class TAParticle_WeepingWillow_Drip extends ParticleDrip {

	private int bobTimer;

	public TAParticle_WeepingWillow_Drip(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn) {
	...
	public void onUpdate() {
		...
		if (this.onGround) {
			...
			this.world.playSound(this.posX, this.posY, this.posZ, TASounds.WEEPINGWILLOWBELL, SoundCategory.BLOCKS, 0.015F, this.rand.nextFloat() * 0.3F + 0.7F, false);
	...
	public static class Factory implements IParticleFactory {
		public Particle createParticle(int particleID, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int... p_178902_15_) {
			return new TAParticle_WeepingWillow_Drip(worldIn, xCoordIn, yCoordIn, zCoordIn);
		}
	}
}
