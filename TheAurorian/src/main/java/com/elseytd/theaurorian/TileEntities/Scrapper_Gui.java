...
public class Scrapper_Gui extends GuiContainer {

	private static final ResourceLocation TEXTURES = new ResourceLocation(TAMod.MODID, "textures/gui/scrapper.png");
	private final InventoryPlayer playerInventory;
	private final IInventory inventory;
	private float craftRotation = 0.0f;

	public Scrapper_Gui(InventoryPlayer playerInv, IInventory inventory) {
		super(new Scrapper_Container(playerInv, inventory));
