...
public class AurorianFurnace_TileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new AurorianFurnace_Container(playerInventory, this);
	}
