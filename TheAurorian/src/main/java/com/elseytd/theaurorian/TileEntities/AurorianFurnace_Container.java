...
public class AurorianFurnace_Container extends Container {
	...
	public AurorianFurnace_Container(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (AurorianFurnace_TileEntity.isItemFuel(itemstack1)) {
