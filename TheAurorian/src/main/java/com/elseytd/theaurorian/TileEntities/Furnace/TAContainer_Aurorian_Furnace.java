...
public class TAContainer_Aurorian_Furnace extends Container {
	...
	public TAContainer_Aurorian_Furnace(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (TATileEntity_Aurorian_Furnace.isItemFuel(itemstack1)) {
