...
public class TATeleport extends Teleporter {
	...
	public TATeleport(WorldServer world, double x, double y, double z) {
		super(world);
	...
	public static void teleportToDimension(EntityPlayer player, int dimension, double x, double y, double z) {
		...
		worldServer.getMinecraftServer().getPlayerList().transferPlayerToDimension(entityPlayerMP, dimension, new TATeleport(worldServer, x, y, z));
