...
public class TABlock_CeruleanAnvil extends BlockFalling {

	public static final String BLOCKNAME = "ceruleananvil";
	...
	public static class TAAnvil implements IInteractionObject {
		private final World world;
		private final BlockPos position;

		public TAAnvil(World worldIn, BlockPos pos) {
			this.world = worldIn;
			this.position = pos;
		}
		...
		public ITextComponent getDisplayName() {
			return new TextComponentTranslation(TABlock_CeruleanAnvil.BLOCKNAME + ".name", new Object[0]);
		}
