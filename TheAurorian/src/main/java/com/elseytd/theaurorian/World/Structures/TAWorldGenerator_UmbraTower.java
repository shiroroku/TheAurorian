...
public class TAWorldGenerator_UmbraTower extends WorldGenerator {
	...
	public static boolean GENERATE_TOWERS = TAConfig.Config_GenerateRuins;
	public static final double CHANCE = 0.01D;

	public static int testt = 0;
	public static int testf = 0;

	@Override
	public boolean generate(World worldIn, Random rand, BlockPos position) {
		boolean gen = false;

		if (TAUtil.randomChanceOf(CHANCE) && TAUtil.randomChanceOf(0.2D)) {
