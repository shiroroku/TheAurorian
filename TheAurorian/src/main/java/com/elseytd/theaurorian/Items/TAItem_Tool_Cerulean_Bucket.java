...
public class TAItem_Tool_Cerulean_Bucket extends UniversalBucket {

	public static final String ITEMNAME = "ceruleanbucket";
	private final ItemStack empty = new ItemStack(this);

	public TAItem_Tool_Cerulean_Bucket() {
	...
	public ICapabilityProvider initCapabilities(final ItemStack stack, final NBTTagCompound nbt) {
		return new TAFluidBucketWrapper(stack, Fluid.BUCKET_VOLUME);
	}
}
