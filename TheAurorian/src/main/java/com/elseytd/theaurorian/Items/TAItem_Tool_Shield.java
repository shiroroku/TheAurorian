...
public class TAItem_Tool_Shield extends Item {

	public TAItem_Tool_Shield() {
	...
	public static void handleDamageEvent(LivingAttackEvent e) {
		...
		if (e.getEntityLiving() instanceof EntityPlayer) {
			...
			if (player.getActiveItemStack() != null) {
				...
				if (damage > 0.0F && activeItemStack != null && activeItemStack.getItem() instanceof TAItem_Tool_Shield) {
					((TAItem_Tool_Shield) activeItemStack.getItem()).onBlockingDamage(activeItemStack, player);
				}
			}
		}
	}
