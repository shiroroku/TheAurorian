...
public class AurorianRabbit_Entity extends EntityAnimal {
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(5, new AurorianRabbit_Entity.AIRaidFarm(this));
	...
	public void updateAITasks() {
		...
		if (this.onGround) {
			...
			AurorianRabbit_Entity.RabbitJumpHelper entityrabbit$rabbitjumphelper = (AurorianRabbit_Entity.RabbitJumpHelper) this.jumpHelper;
	...
	private void enableJumpControl() {
		((AurorianRabbit_Entity.RabbitJumpHelper) this.jumpHelper).setCanJump(true);
	}

	private void disableJumpControl() {
		((AurorianRabbit_Entity.RabbitJumpHelper) this.jumpHelper).setCanJump(false);
	}
	...
	public static void registerFixesRabbit(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, AurorianRabbit_Entity.class);
	}
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		if (livingdata instanceof AurorianRabbit_Entity.RabbitTypeData) {
			i = ((AurorianRabbit_Entity.RabbitTypeData) livingdata).typeData;
			flag = true;
		} else {
			livingdata = new AurorianRabbit_Entity.RabbitTypeData(i);
		}
	...
	static class RabbitMoveHelper extends EntityMoveHelper {
		...
		public void onUpdateMoveHelper() {
			if (this.rabbit.onGround && !this.rabbit.isJumping && !((AurorianRabbit_Entity.RabbitJumpHelper) this.rabbit.jumpHelper).getIsJumping()) {
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		return new AurorianRabbit_Entity(this.world);
	}
}