...
public class CeruleanArrow_EntityRender extends Render<CeruleanArrow_Entity> {
	
	private ResourceLocation mobTexture = new ResourceLocation(TAMod.MODID, "textures/entity/ceruleanarrow.png");
	public static final Factory FACTORY = new Factory();

	public CeruleanArrow_EntityRender(RenderManager rendermanagerIn) {
		super(rendermanagerIn);
	}

	@Override
	public void doRender(CeruleanArrow_Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	@Nonnull
	protected ResourceLocation getEntityTexture(@Nonnull CeruleanArrow_Entity entity) {
		return mobTexture;
	}

	public static class Factory implements IRenderFactory<CeruleanArrow_Entity> {

		@Override
		public Render<? super CeruleanArrow_Entity> createRenderFor(RenderManager manager) {
			return new CeruleanArrow_EntityRender(manager);
		}
