...
public class CrystalArrow_Entity extends EntityArrow {
	...
	public CrystalArrow_Entity(World worldIn) {
		super(worldIn);
		this.setStats();
	}

	public CrystalArrow_Entity(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
		this.setStats();
	}

	public CrystalArrow_Entity(World worldIn, EntityLivingBase shooter) {
	...
	protected ItemStack getArrowStack() {
		return new ItemStack(TAItems.Registry.CRYSTALARROW.getItem());
	}
}
