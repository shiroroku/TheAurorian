...
public class TAEntity_CeruleanArrow extends EntityArrow {
	...
	public TAEntity_CeruleanArrow(World worldIn) {
		super(worldIn);
		setStats();
	}

	public TAEntity_CeruleanArrow(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
		setStats();
	}

	public TAEntity_CeruleanArrow(World worldIn, EntityLivingBase shooter) {
