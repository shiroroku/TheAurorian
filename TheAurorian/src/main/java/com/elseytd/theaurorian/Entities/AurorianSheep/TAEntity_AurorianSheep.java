...
public class TAEntity_AurorianSheep extends EntityAnimal implements net.minecraftforge.common.IShearable {
	...
	private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(TAEntity_AurorianSheep.class, DataSerializers.BYTE);
	private static final Map<EnumDyeColor, float[]> DYE_TO_RGB = Maps.newEnumMap(EnumDyeColor.class);
	private int sheepTimer;
	private TAEntityAI_EatGrass entityAIEatGrass;
	...
	public TAEntity_AurorianSheep(World worldIn) {
		super(worldIn);
	...
	protected void initEntityAI() {
		this.entityAIEatGrass = new TAEntityAI_EatGrass(this);
	...
	public static void registerFixesSheep(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, TAEntity_AurorianSheep.class);
	}
	...
	@Override
	public TAEntity_AurorianSheep createChild(EntityAgeable ageable) {
		TAEntity_AurorianSheep entitysheep = (TAEntity_AurorianSheep) ageable;
		TAEntity_AurorianSheep entitysheep1 = new TAEntity_AurorianSheep(this.world);
	...
	private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother) {
		int i = ((TAEntity_AurorianSheep) father).getFleeceColor().getDyeDamage();
		int j = ((TAEntity_AurorianSheep) mother).getFleeceColor().getDyeDamage();
		this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
		this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
		ItemStack itemstack = CraftingManager.findMatchingResult(this.inventoryCrafting, ((TAEntity_AurorianSheep) father).world);
		int k;
