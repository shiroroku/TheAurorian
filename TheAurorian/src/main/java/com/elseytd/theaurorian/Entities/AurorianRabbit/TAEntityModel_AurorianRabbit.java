...
public class TAEntityModel_AurorianRabbit extends ModelBase {
	...
	public TAEntityModel_AurorianRabbit() {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		TAEntity_AurorianRabbit entityrabbit = (TAEntity_AurorianRabbit) entityIn;
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
		...
		this.jumpRotation = MathHelper.sin(((TAEntity_AurorianRabbit) entitylivingbaseIn).setJumpCompletion(partialTickTime) * (float) Math.PI);
	}
