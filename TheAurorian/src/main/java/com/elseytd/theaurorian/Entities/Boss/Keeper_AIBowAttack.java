...
public class Keeper_AIBowAttack extends EntityAIBase {
	...
	public Keeper_AIBowAttack(IRangedAttackMob attacker, double movespeed, int maxAttackTime, float maxAttackDistanceIn) {
		this(attacker, movespeed, maxAttackTime, maxAttackTime, maxAttackDistanceIn);
	}

	public Keeper_AIBowAttack(IRangedAttackMob attacker, double movespeed, int p_i1650_4_, int maxAttackTime, float maxAttackDistanceIn) {
	...
	public void startExecuting() {
		...
		this.entityHost.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(TAItems.Registry.SILENTWOODBOW.getItem()));
	}
