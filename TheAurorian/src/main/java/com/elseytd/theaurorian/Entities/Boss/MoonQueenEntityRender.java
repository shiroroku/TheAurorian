...
public class MoonQueenEntityRender extends RenderLiving<MoonQueenEntity> {
	...
	private ResourceLocation mobTexture = new ResourceLocation(AurorianMod.MODID, "textures/entity/" + MoonQueenEntity.EntityName + ".png");
	private float mobScale = MoonQueenEntity.MobScale;
