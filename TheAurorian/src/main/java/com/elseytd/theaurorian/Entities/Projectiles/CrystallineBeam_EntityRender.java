...
public class CrystallineBeam_EntityRender extends Render<CrystallineBeam_Entity> {
	...
	public CrystallineBeam_EntityRender(RenderManager rendermanagerIn) {
		super(rendermanagerIn);
	}

	@Override
	public void doRender(CrystallineBeam_Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	@Nonnull
	protected ResourceLocation getEntityTexture(@Nonnull CrystallineBeam_Entity entity) {
		return mobTexture;
	}

	public static class Factory implements IRenderFactory<CrystallineBeam_Entity> {

		@Override
		public Render<? super CrystallineBeam_Entity> createRenderFor(RenderManager manager) {
			return new CrystallineBeam_EntityRender(manager);
		}
