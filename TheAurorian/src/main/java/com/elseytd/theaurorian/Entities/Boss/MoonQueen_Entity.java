...
public class MoonQueen_Entity extends EntityMob {
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(1, new MoonQueen_AICharge(this, true));
		this.tasks.addTask(2, new MoonQueen_AISideStrafe(this));
	...
	public void onDeath(DamageSource cause) {
		...
		if (te != null) {
			if (te instanceof TileEntityChest) {
				((TileEntityChest) te).setLootTable(MoonQueen_Entity.CHEST_LOOT, this.getRNG().nextLong());
			}
		} else {
