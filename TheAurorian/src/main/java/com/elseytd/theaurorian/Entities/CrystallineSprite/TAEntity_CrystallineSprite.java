...
public class TAEntity_CrystallineSprite extends EntityMob implements IRangedAttackMob {
	...
	protected void initEntityAI() {
		this.tasks.addTask(2, new TAEntityAI_RangedAttack(this, 0.85F, 40, 40F));
