...
import com.elseytd.theaurorian.Blocks.DungeonStone;
import com.elseytd.theaurorian.Blocks.DungeonStoneLamp;
import com.elseytd.theaurorian.Blocks.DungeonStoneSmooth;
...
public class AurorianSheepEntity extends EntityAnimal implements net.minecraftforge.common.IShearable {
	...
	private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(AurorianSheepEntity.class, DataSerializers.BYTE);
	...
	private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother) {
		...
		ItemStack itemstack = CraftingManager.findMatchingResult(this.inventoryCrafting, ((AurorianSheepEntity) father).world);
		int k;
