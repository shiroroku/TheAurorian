...
public class AurorianSheep_Entity extends EntityAnimal implements net.minecraftforge.common.IShearable {
	...
	protected void initEntityAI() {
		this.entityAIEatGrass = new AurorianSheep_AIEatGrass(this);
	...
	public static void registerFixesSheep(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, AurorianSheep_Entity.class);
	}
	...
	@Override
	public AurorianSheep_Entity createChild(EntityAgeable ageable) {
		AurorianSheep_Entity entitysheep = (AurorianSheep_Entity) ageable;
		AurorianSheep_Entity entitysheep1 = new AurorianSheep_Entity(this.world);
	...
	private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother) {
		int i = ((AurorianSheep_Entity) father).getFleeceColor().getDyeDamage();
		int j = ((AurorianSheep_Entity) mother).getFleeceColor().getDyeDamage();
		this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
		this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
		ItemStack itemstack = CraftingManager.findMatchingResult(this.inventoryCrafting, ((AurorianSheep_Entity) father).world);
		int k;
