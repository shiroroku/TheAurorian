...
public class TAEntity_AurorianRabbit extends EntityAnimal {
	...
	public TAEntity_AurorianRabbit(World worldIn) {
		super(worldIn);
		this.spawnableBlock = TABlocks.auroriangrass;
		this.setSize(0.4F, 0.5F);
		this.jumpHelper = new TAEntity_AurorianRabbit.RabbitJumpHelper(this);
		this.moveHelper = new TAEntity_AurorianRabbit.RabbitMoveHelper(this);
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(1, new TAEntity_AurorianRabbit.AIPanic(this, 2.2D));
		...
		this.tasks.addTask(5, new TAEntity_AurorianRabbit.AIRaidFarm(this));
	...
	public void updateAITasks() {
		...
		if (this.onGround) {
			...
			TAEntity_AurorianRabbit.RabbitJumpHelper entityrabbit$rabbitjumphelper = (TAEntity_AurorianRabbit.RabbitJumpHelper) this.jumpHelper;
	...
	private void enableJumpControl() {
		((TAEntity_AurorianRabbit.RabbitJumpHelper) this.jumpHelper).setCanJump(true);
	}

	private void disableJumpControl() {
		((TAEntity_AurorianRabbit.RabbitJumpHelper) this.jumpHelper).setCanJump(false);
	}
	...
	public static void registerFixesRabbit(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, TAEntity_AurorianRabbit.class);
	}
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		if (livingdata instanceof TAEntity_AurorianRabbit.RabbitTypeData) {
			i = ((TAEntity_AurorianRabbit.RabbitTypeData) livingdata).typeData;
			flag = true;
		} else {
			livingdata = new TAEntity_AurorianRabbit.RabbitTypeData(i);
		}
	...
	static class AIPanic extends EntityAIPanic {
		private final TAEntity_AurorianRabbit rabbit;

		public AIPanic(TAEntity_AurorianRabbit rabbit, double speedIn) {
	...
	static class AIRaidFarm extends EntityAIMoveToBlock {
		...
		public AIRaidFarm(TAEntity_AurorianRabbit rabbitIn) {
	...
	public class RabbitJumpHelper extends EntityJumpHelper {
		...
		public RabbitJumpHelper(TAEntity_AurorianRabbit rabbit) {
			super(rabbit);
			this.rabbit = rabbit;
		}
	...
	static class RabbitMoveHelper extends EntityMoveHelper {
		...
		public RabbitMoveHelper(TAEntity_AurorianRabbit rabbit) {
			super(rabbit);
			this.rabbit = rabbit;
		}
		...
		public void onUpdateMoveHelper() {
			if (this.rabbit.onGround && !this.rabbit.isJumping && !((TAEntity_AurorianRabbit.RabbitJumpHelper) this.rabbit.jumpHelper).getIsJumping()) {
	...
	public EntityAgeable createChild(EntityAgeable ageable) {
		return new TAEntity_AurorianRabbit(this.world);
	}
}