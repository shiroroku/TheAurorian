...
public class TAEntity_DisturbedHollow extends EntityMob {
	...
	private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.createKey(TAEntity_DisturbedHollow.class, DataSerializers.BOOLEAN);

	public TAEntity_DisturbedHollow(World worldIn) {
		super(worldIn);
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(2, new TAEntityAI_DisturbedHollowAttack(this, 1.0D, false));
