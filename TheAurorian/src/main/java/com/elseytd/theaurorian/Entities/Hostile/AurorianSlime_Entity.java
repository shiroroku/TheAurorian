...
public class AurorianSlime_Entity extends EntityLiving implements IMob {
	...
	public AurorianSlime_Entity(World worldIn) {
		super(worldIn);
		this.height = 0.75F;
		this.moveHelper = new AurorianSlime_Entity.SlimeMoveHelper(this);
	}

	@Override
	protected void initEntityAI() {
		this.tasks.addTask(1, new AurorianSlime_Entity.AISlimeFloat(this));
		this.tasks.addTask(2, new AurorianSlime_Entity.AISlimeAttack(this));
		this.tasks.addTask(3, new AurorianSlime_Entity.AISlimeFaceRandom(this));
		this.tasks.addTask(5, new AurorianSlime_Entity.AISlimeHop(this));
	...
	public static void registerFixesSlime(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, AurorianSlime_Entity.class);
	}
	...
	protected AurorianSlime_Entity createInstance() {
		return new AurorianSlime_Entity(this.world);
	}
	...
	static class AISlimeAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			((AurorianSlime_Entity.SlimeMoveHelper) this.slime.getMoveHelper()).setDirection(this.slime.rotationYaw, true);
		}
	}
	...
	static class AISlimeFloat extends EntityAIBase {
		...
		public void updateTask() {
			...
			((AurorianSlime_Entity.SlimeMoveHelper) this.slime.getMoveHelper()).setSpeed(1.2D);
		}
	}
	...
	static class AISlimeHop extends EntityAIBase {
		...
		@Override
		public void updateTask() {
			((AurorianSlime_Entity.SlimeMoveHelper) this.slime.getMoveHelper()).setSpeed(1.5D);
		}
	}
