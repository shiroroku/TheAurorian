...
public class MoonstonePickaxe extends BaseAurorianPickaxe {

    public MoonstonePickaxe(ForgeTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
