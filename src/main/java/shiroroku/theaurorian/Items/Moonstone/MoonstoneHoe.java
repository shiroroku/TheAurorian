...
public class MoonstoneHoe extends BaseAurorianHoe {

    public MoonstoneHoe(ForgeTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
