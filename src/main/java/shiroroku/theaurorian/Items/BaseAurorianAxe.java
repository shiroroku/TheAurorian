...
public class BaseAurorianAxe extends AxeItem {

    private int burnTime = 0;

    public BaseAurorianAxe(Tier pTier, Properties pProperties, int burnTime) {
        super(pTier, pProperties);
        this.burnTime = burnTime;
    }

    public BaseAurorianAxe(Tier pTier, Properties pProperties) {
        super(pTier, pProperties);
    }
