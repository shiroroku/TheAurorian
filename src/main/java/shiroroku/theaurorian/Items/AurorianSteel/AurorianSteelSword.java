...
public class AurorianSteelSword extends BaseAurorianSword {

    public AurorianSteelSword(ForgeTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
