...
public class AurorianSteelPickaxe extends BaseAurorianPickaxe {

    public AurorianSteelPickaxe(ForgeTier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
