...
public class AurorianSteelAxe extends BaseAurorianAxe {

    public AurorianSteelAxe(ForgeTier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
