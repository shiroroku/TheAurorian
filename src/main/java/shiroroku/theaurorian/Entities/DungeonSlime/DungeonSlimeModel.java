...
public class DungeonSlimeModel extends HierarchicalModel<DungeonSlimeEntity> {
    ...
    @Override
    public void setupAnim(DungeonSlimeEntity dungeonSlimeEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
    }
}
