...
public class AurorianFurnaceContainer extends Container {
	...
	public AurorianFurnaceContainer(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (AurorianFurnaceTileEntity.isItemFuel(itemstack1)) {
