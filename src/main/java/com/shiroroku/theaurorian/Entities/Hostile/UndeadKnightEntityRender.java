...
public class UndeadKnightEntityRender extends RenderLiving<UndeadKnightEntity> {
	...
	private ResourceLocation mobTexture = new ResourceLocation(AurorianMod.MODID, "textures/entity/" + UndeadKnightEntity.EntityName + ".png");
	private float mobScale = UndeadKnightEntity.MobScale;
