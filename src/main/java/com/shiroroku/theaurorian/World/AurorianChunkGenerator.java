...
public class AurorianChunkGenerator implements IChunkGenerator {
	...
	private AurorianTerrainGenerator terraingen = new AurorianTerrainGenerator();

	private RunestoneTowerWorldGenerator towergen = new RunestoneTowerWorldGenerator();
	private RuinsWorldGenerator ruingen = new RuinsWorldGenerator();
	private MoonTempleWorldGenerator templegen = new MoonTempleWorldGenerator();
	private UmbraTowerWorldGenerator umbratowergen = new UmbraTowerWorldGenerator();
	private DarkstoneDungeonWorldGenerator darkstonegen = new DarkstoneDungeonWorldGenerator();
	private GraveyardWorldGenerator graveyardgen = new GraveyardWorldGenerator();
