...
public class SilentwoodTreeWorldGenerator extends WorldGenAbstractTree {
	...
	private IBlockState blockStateWood = BlockRegistry.Registry.SILENTWOODLOG.getBlock().getDefaultState();
	private IBlockState blockStateLeaves = BlockRegistry.Registry.SILENTWOODLEAVES.getBlock().getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
